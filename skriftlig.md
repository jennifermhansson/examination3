...
Jag hade valt att lägga till en connection pool mot databasen för att hantera många anrop och få bättre prestanda. I min nuvarande app skulle svarstiden för varje anrop kunna bli sämre vid hög belastning.
Jag hade valt att logga alla felmeddelanden i databasen så att jag snabbt kan följa upp och felsöka om ett fel inträffar. I min nuvarande uppsättning skulle ett fel gå förlorat.
...
Även om syntaxen är annorlunda i PHP så följer båda liknande struktur för att bygga upp backenden. Jag gjorde PHP projektet efter att jag gjort klart Fastify/Bun projektet och insåg snabbt att det krävdes mycket mindre kod och tid med PHP för att göra "samma" sak som jag redan spenderat flera timmar att göra i Fastify. Jag tror att det finns en fördel med PHP, dels att syntaxen påminner om java , C# vilket är bra för att lära sig vara "mångspråkig" och att du snabbt kan sätta upp en backend och frontend och att hela appen körs server side.

Men, för en junior utvecklare känns det som att Fastify och Bun är mycket snabbare och har bättre prestanda men det beror på vad för typ av app man ska bygga.
När jag har sökt runt för att läsa mer om PHP så hittar jag väldigt mycket stabil information, guider och tutorials, vilket är förståeligt då det är ett mycket äldre och på det viset stabilare språk.
...
Mitt projekt, som egentligen började som en blogg, passar jättebra i PHP men exempelvis projektet med Chatappen hade nog inte passat lika bra pga att den behöver hålla anslutningen öppen för att lyssna på servern efter nya meddelanden, medan PHP skickar request och response vilket skulle starta en ny process ex vid varje nytt meddelande.
